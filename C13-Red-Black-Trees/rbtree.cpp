...
public:
  RedBlackTreeNode()
      : key(T()), parent(NULL), left(NULL), right(NULL), color(BLACK) {}
  T key;
...
template <class T> RedBlackTree<T>::RedBlackTree() { root = NULL; }

template <class T> int RedBlackTree<T>::search_element(const T &k) const {
  return (NIL != search_tree_node(k));
}

template <class T> int RedBlackTree<T>::get_minmum(T &retmin) const {
  if (root) {
...
template <class T> int RedBlackTree<T>::get_maxmum(T &retmax) const {
  if (root) {
...
template <class T> int RedBlackTree<T>::insert_key(const T &k) {
...
template <class T> int RedBlackTree<T>::delete_key(const T &k) {
  RedBlackTreeNode<T> *pnode = search_tree_node(k);
  if (NIL != pnode) {
...
template <class T> RedBlackTree<T>::~RedBlackTree() { make_empty(root); }
template <class T> RedBlackTreeNode<T> *RedBlackTree<T>::get_root() const {
  return root;
}
template <class T>
RedBlackTreeNode<T> *
RedBlackTree<T>::get_parent(RedBlackTreeNode<T> *pnode) const {
  return pnode->parent;
}
template <class T>
RedBlackTreeNode<T> *
RedBlackTree<T>::get_left(RedBlackTreeNode<T> *pnode) const {
  return pnode->left;
}
template <class T>
RedBlackTreeNode<T> *
RedBlackTree<T>::get_right(RedBlackTreeNode<T> *pnode) const {
  return pnode->right;
}
template <class T>
  ...
  while (pnode != root && get_color(pnode) == BLACK) {
    ...
    if (pnode == get_left(get_parent(pnode))) {
      ...
      if (get_color(get_left(qnode)) == BLACK &&
          get_color(get_right(qnode)) == BLACK) {
        set_color(qnode, RED);
        pnode = get_parent(pnode);
      } else {
      ...
      if (get_color(get_right(qnode)) == BLACK &&
          get_color(get_left(qnode)) == BLACK) {
        set_color(qnode, RED);
        pnode = get_parent(pnode);
      } else {
        if (get_color(get_left(qnode)) == BLACK) {
...
template <class T>
RedBlackTreeNode<T> *
RedBlackTree<T>::get_maxmum(RedBlackTreeNode<T> *root) const {
  RedBlackTreeNode<T> *pnode = root;
...
template <class T>
RedBlackTreeNode<T> *
RedBlackTree<T>::get_minmum(RedBlackTreeNode<T> *root) const {
  RedBlackTreeNode<T> *pnode = root;
...
template <class T>
RedBlackTreeNode<T> *
RedBlackTree<T>::get_successor(RedBlackTreeNode<T> *pnode) const {
  if (pnode->right != NIL)
...
template <class T>
RedBlackTreeNode<T> *
RedBlackTree<T>::get_predecessor(RedBlackTreeNode<T> *pnode) const {
  if (pnode->left != NIL)
...
template <class T> void RedBlackTree<T>::make_empty(RedBlackTreeNode<T> *root) {
  if (root) {
...
template <class T> void RedBlackTree<T>::inorder_tree_walk() const {
  if (NULL != root) {
